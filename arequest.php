...
$sql = "SELECT name, email, num ,city ,zip ,text FROM req";
$result = $conn->query($sql);

if ($result->num_rows > 0) {
     echo "<table><tr><center><th>Name&nbsp;&nbsp;&nbsp;&nbsp;</th></center><th>Email&nbsp;&nbsp;&nbsp;&nbsp;</th><th>Number&nbsp;&nbsp;&nbsp;&nbsp;</th><th>City&nbsp;&nbsp;&nbsp;&nbsp;</th><th>Zip&nbsp;&nbsp;&nbsp;&nbsp;</th><th>Complaint&nbsp;&nbsp;&nbsp;&nbsp;</th></tr>";
     // output data of each row
     while($row = $result->fetch_assoc()) {
         echo "<tr><td>" . $row["name"]. "</td><td>" . $row["email"]. "</td><td>" . $row["num"]. "</td><td>" . $row["city"]. "</td><td>" . $row["zip"]. "</td><td>" . $row["text"]. "</td></tr>";
     }
     echo "</table>";
} else {
     echo "0 results";
