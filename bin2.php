...
<div id="dom-target4" style="display: none;">
 ...
 <div id="dom-target3" style="display: none;">
		...
		<div class="row">
                <!-- Page Header -->
                <div class="col-lg-12">
                    <h1 class="page-header">Contents of Bin-2</h1>
                </div>
                <!--End Page Header -->
            </div>
...
<div style="<?php echo htmlspecialchars($br2);?>">
						 ...
						 <div style="<?php echo htmlspecialchars($br2);?>">
						  ...
						  <legend>Filled date and time  :&nbsp;&nbsp;&nbsp;&nbsp;<?php echo htmlspecialchars($t2);?></legend></br>
						    <legend>Location of Bin:&nbsp;&nbsp;&nbsp;&nbsp;<?php echo htmlspecialchars($lt2);?>LT,&nbsp;&nbsp;<?php echo htmlspecialchars($ln2);?>LN&nbsp;&nbsp;<a href="binmap2.php" <button type="button" target="_blank" class="btn btn-danger">View on Map</button></a></legend></br>
