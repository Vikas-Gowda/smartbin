    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
			 ...
			 <div class="row">
                <!-- Page Header -->
                <div class="col-lg-12">
                    <h1 class="page-header">Requested Bin Details</h1>
                </div>
                <!--End Page Header -->
            </div>
<?php
...
$sql = "SELECT name, email, num ,city ,zip ,lat ,lan FROM comp";
$result = $conn->query($sql);

if ($result->num_rows > 0) {
     echo "<table><tr><center><th>Name&nbsp;&nbsp;&nbsp;&nbsp;</th></center><th>Email&nbsp;&nbsp;&nbsp;&nbsp;</th><th>Number&nbsp;&nbsp;&nbsp;&nbsp;</th><th>City&nbsp;&nbsp;&nbsp;&nbsp;</th><th>Zip&nbsp;&nbsp;&nbsp;&nbsp;</th><th>Latitude&nbsp;&nbsp;&nbsp;&nbsp;</th><th>Landitude&nbsp;&nbsp;&nbsp;&nbsp;</th></tr>";
     // output data of each row
     while($row = $result->fetch_assoc()) {
         echo "<tr><td>" . $row["name"]. "</td><td>" . $row["email"]. "</td><td>" . $row["num"]. "</td><td>" . $row["city"]. "</td><td>" . $row["zip"]. "</td><td>" . $row["lat"]. "</td><td>" . $row["lan"]. "</td></tr>";
     }
     echo "</table>";
} else {
     echo "0 results";
