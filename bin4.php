...
<div id="dom-target4" style="display: none;">
 ...
 <div id="dom-target3" style="display: none;">
		...
		<div class="row">
                <!-- Page Header -->
                <div class="col-lg-12">
                    <h1 class="page-header">Contents of Bin-4</h1>
                </div>
                <!--End Page Header -->
            </div>
...
<div style="<?php echo htmlspecialchars($br4);?>">
						  ...
						  <legend>Filled date and time  :&nbsp;&nbsp;&nbsp;&nbsp;<?php echo htmlspecialchars($t4);?></legend></br>
						  <legend>Location of Bin:&nbsp;&nbsp;&nbsp;&nbsp;<?php echo htmlspecialchars($lt4);?>LT,&nbsp;&nbsp;<?php echo htmlspecialchars($ln4);?>LN&nbsp;&nbsp;<a href="binmap4.php" <button type="button" target="_blank" class="btn btn-danger">View on Map</button></a></legend></br>
