...
<div id="dom-target4" style="display: none;">
 ...
 <li class="dropdown">
		...
		<div class="row">
                <!-- Page Header -->
                <div class="col-lg-12">
                    <h1 class="page-header">Contents of Bin-3</h1>
                </div>
                <!--End Page Header -->
            </div>
...
<div style="<?php echo htmlspecialchars($br3);?>">
						  ...
						  <legend>Filled date and time  :&nbsp;&nbsp;&nbsp;&nbsp;<?php echo htmlspecialchars($t3);?></legend></br>
						  <legend>Location of Bin:&nbsp;&nbsp;&nbsp;&nbsp;<?php echo htmlspecialchars($lt3);?>LT,&nbsp;&nbsp;<?php echo htmlspecialchars($ln3);?>LN&nbsp;&nbsp;<a href="binmap3.php" <button type="button" target="_blank" class="btn btn-danger">View on Map</button></a></legend></br>
