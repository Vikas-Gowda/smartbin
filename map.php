    ...
    <div id="wrapper">
            ...
            <div class="sidebar-collapse">
                ...
                <ul class="nav" id="side-menu">
                   ...
                   <li class="selected">
					...
					<li >
                        <a href="acomplaint.php" ><i class="fa fa-user"></i>&nbsp;Complaints</a>
                    </li>
					
					<li>
                        <a href="arequest.php" ><i class="fa fa-user"></i>&nbsp;Request Bin</a>
                    </li>
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                <!-- Page Header -->
                <div class="col-lg-12">
                    <h1 class="page-header">SDMIT Campus</h1>
                </div>
                <!--End Page Header -->
            </div>
